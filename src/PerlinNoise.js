...
function noise2d(x, y) {
    ...
    var a = ptable((temp >> 8  ) + (y >> 16 & 0xff /* Unit square Y */));
    var b = ptable((temp & 0xff) + (y >> 16 & 0xff                    ));
    ...
    var c = lerp(u, grad2(a >> 8  , x, y        ), grad2(b >> 8  , x-0x10000, y        ));
    var d = lerp(u, grad2(a & 0xff, x, y-0x10000), grad2(b & 0xff, x-0x10000, y-0x10000));
